...
namespace Conference.Api.Public
{
    ...
    public class WebRole : RoleEntryPoint
    {
        ...
        public override bool OnStart()
        {
            ...
            Microsoft.WindowsAzure.Diagnostics.LogLevel logLevel;
            if (!Enum.TryParse<Microsoft.WindowsAzure.Diagnostics.LogLevel>(RoleEnvironment.GetConfigurationSettingValue("Diagnostics.LogLevelFilter"), out logLevel))
            {
                logLevel = Microsoft.WindowsAzure.Diagnostics.LogLevel.Verbose;
            }
